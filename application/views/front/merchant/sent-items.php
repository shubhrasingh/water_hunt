                              ...
                              <div class="row m-t-md">
                                  ...
                                  <div class="col-md-2">
                                      <ul class="list-unstyled mailbox-nav" style="background: #e5e8ea;">
                                          ...
                                          <li><a href="<?php echo base_url(); ?>merchant/messages/sent-items"><i class="fa fa-reply"></i>  Sent <span class="badge badge-default pull-right"><?php echo $sentItemsCount; ?></span></a></li>
