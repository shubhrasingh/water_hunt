                ...
                <div id="main-wrapper">
                    ...
                    <div class="row">
                                ...
                                <div class="panel-body">
                                    <form  method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" required  name="title" class="form-control m-t-xxs" id="title" placeholder="Title of Image .... ">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <textarea name="description" required="required" rows="2"  class="form-control m-t-xxs" placeholder="description ..." ></textarea>
                                            </div>
                                             <div class="col-md-4">
                                                 <button type="submit" class="btn btn-info m-t-xs m-b-xs" name="submit">Add Gallery</button>
                                             </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Merchant`s Gallery Of <b><?php echo ucfirst($merchants[0]->waterpark_name); ?></b></h4>
                                </div>
                        <div class="panel-body">
                                ...
                                <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row_<?php echo $value->id; ?>">
                                                ...
                                                <td><img src="<?php echo base_url(); ?>assets/front/uploads/gallery/<?php echo  $value->image; ?>" style="height: 63px;"></td>
