                                    ...
                                    <?php echo form_open_multipart(); ?>
                                       ...
                                       <input type="hidden" name="rowid" value="<?php echo $getData[0]->id; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control m-t-xxs" id="exampleInputEmail1" placeholder="Enter Name" value="<?php echo $getData[0]->name; ?>" name="name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Comment</label>
                                            <textarea class="form-control m-t-xxs" id="exampleInputEmail1" placeholder="Enter Comment" name="comment" ><?php echo $getData[0]->comment; ?></textarea>
                                        </div>
