        ...
        <link href="<?php echo base_url(); ?>assets/admin/plugins/offcanvasmenueffects/css/menu_cornerbox.css" rel="stylesheet" type="text/css"/>	
		...
		<!-- for form element Materials-->
		<link href="<?php echo base_url(); ?>assets/admin/plugins/summernote-master/summernote.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url(); ?>assets/admin/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css" rel="stylesheet" type="text/css"/>
        ...
        <!-- Theme Styles -->
        <link href="<?php echo base_url(); ?>assets/admin/css/meteor.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url(); ?>assets/admin/css/layers/dark-layer.css" class="theme-color" rel="stylesheet" type="text/css"/>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/plugins/offcanvasmenueffects/js/snap.svg-min.js"></script>
		
		
       
        <!--   For use of Select Option tag -->
