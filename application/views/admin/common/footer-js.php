<!-- Javascripts -->
        <script src="<?php echo base_url(); ?>assets/admin/plugins/jquery/jquery-3.1.0.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/js/meteor.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>assets/admin/js/pages/profile.js"></script>
		
		
		
		<!--   for Use to select -> Option tag-->
	
        <script src="<?php echo base_url(); ?>assets/admin/plugins/select2/js/select2.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/admin/js/pages/form-select2.js"></script>