                        ...
                        <div class="col-md-12">
                           <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">All Testimonial </h4>
                                ...
                                <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url(); ?>admin/edit-testimonial/<?php echo $row->id; ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
