                                ...
                                <div class="panel-body">
                                    ...
                                    <?php echo form_open_multipart(); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control m-t-xxs" id="exampleInputEmail1" placeholder="Enter Title" name="title" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Description</label>
                                            <textarea class="form-control m-t-xxs" id="exampleInputEmail1" placeholder="Enter Description" name="description" ></textarea>
                                        </div>
                                        <div class="form-group">
