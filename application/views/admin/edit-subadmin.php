                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Update Subadmin</h4>
                                </div>
                                <div class="panel-body">
                                    <form  method="post" action="" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" required value="<?php echo $singlesubadmin[0]->name; ?>"  name="name" class="form-control m-t-xxs" id="title" placeholder="Name of sub-admin * ">
                                            <input type="hidden" value="<?php echo $singlesubadmin[0]->id; ?>" name="id">
                                           ...
                                           <input type="email" required value="<?php echo $singlesubadmin[0]->email; ?>"  name="email" class="form-control" placeholder="email of subadmin  here * " />
                                            </div>

                                          <div class="col-md-4">
                                            <label for="description">Password : <span class="text-danger">*</span>  </label>
                                            <input type="text" required="required" value="<?php echo $singlesubadmin[0]->password; ?>" name="password" class="form-control" placeholder="password here  * ">
                                           </div>
                                         ...
                                         <div class="form-group row">
                                            <div class="col-md-8">
                                             ...
                                             <div class="col-md-4">
                                                 <button type="submit" class="btn btn-info m-t-xs m-b-xs" name="update">Update SubAdmin</button>
                                             </div>
