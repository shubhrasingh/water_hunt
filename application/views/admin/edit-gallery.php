                                ...
                                <div class="panel-body">
                                    <form  method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" required  name="title" class="form-control m-t-xxs"value="<?php echo  $singlegallery[0]->title; ?>" placeholder="Title of Image .... ">
                                           ...
                                           <input type="file"   name="file" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                              <img src="<?php echo  base_url(); ?>assets/front/uploads/gallery/<?php echo $singlegallery[0]->image; ?>" style="height:100px;">
                                            </div>
